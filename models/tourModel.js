...
const tourSchema = new mongoose.Schema(
  {
    ...
    maxGroupSize: {
      type: Number,
      required: [true, 'A tour mus have a maxGroupSize'],
    },
    difficulty: {
      type: String,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          /// This only points to current docon New documentcreation
...
// Embeding tour-guide user to tour
...
tourSchema.pre('save', function (next) {
  ...
  // this.imageCover = `/img/tours/${this.imageCover}`;
  next();
});
